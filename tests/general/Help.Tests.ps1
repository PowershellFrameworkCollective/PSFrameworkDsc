...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PSFrameworkDsc\functions", "$global:testroot\..\PSFrameworkDsc\internal\functions"),
	
	[string]
	$ModuleName = "PSFrameworkDsc",
...
$CommandPath = @(
    "$global:testroot\..\PSFrameworkDsc\functions"
    "$global:testroot\..\PSFrameworkDsc\internal\functions"
)
