...
Remove-Module PSFrameworkDsc -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSFrameworkDsc\PSFrameworkDsc.psd1"
Import-Module "$PSScriptRoot\..\PSFrameworkDsc\PSFrameworkDsc.psm1" -Force
